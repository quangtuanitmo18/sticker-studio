...
export default function PhotoboothPage() {
  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-start lg:justify-center p-0 lg:p-6 bg-[var(--canvas-bg)] overflow-y-auto gap-2 lg:gap-6 pb-48 lg:pb-6" onClick={() => setSelectedOverlay(null)}>
        {/* Camera */}
        <div className="relative w-full lg:max-w-[640px]">
          <div className="relative rounded-none lg:rounded-2xl overflow-hidden shadow-2xl" style={{
